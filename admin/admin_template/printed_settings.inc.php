...
$sysconf['print']['label']['border_size'] = 2; // in pixels
...
$sysconf['print']['barcode']['barcode_box_width'] = 9.5;
$sysconf['print']['barcode']['barcode_box_height'] = 3.5;
$sysconf['print']['barcode']['barcode_include_header_text'] = 1; // change to 0 if dont want to use header in each barcode
$sysconf['print']['barcode']['barcode_cut_title'] = 15; // maximum characters in title to appear in each barcode. change to 0 if you dont want the title cutted
$sysconf['print']['barcode']['barcode_header_text'] = "Perpustakaan Baitul Hikmah <br> SMA IT Abu Bakar </br>"; // keep empty if you want to use Library Name as a header text
$sysconf['print']['barcode']['barcode_fonts'] = "Arial, Verdana, Helvetica, 'Trebuchet MS'"; // font to use
$sysconf['print']['barcode']['barcode_font_size'] = 9;
$sysconf['print']['barcode']['barcode_scale'] = 100; // barcode scale in percent relative to box width and height
$sysconf['print']['barcode']['barcode_border_size'] = 2; // in pixels
...
/*Add to Plugin Kartu Buku Start*/
$bookcard_page_margin = 0.2; //ukuran margin halaman
$bookcard_items_per_row = 2; //jumlah kartu buku perbaris
$bookcard_width = 9; //lebar kartu buku dalam satuan CM
$bookcard_height = 10; // tinggi minimal kartu buku 
$bookcard_include_header_text = 1; // ubah 0 jika tidak tercetak nama perpustakaan
$bookcard_address_text = ''; // tuliskan alamat perpustakaan di sini 
$bookcard_header_text = ''; // biarkan kosong jika nama perpustakaan sesuai nama perpustakaan pada SLiMS
$bookcard_cut_title = 36; // banyak nya karakter yang tercetak pada judul buku. ubah 0 jika nama tidak terpotong
$bookcard_cut_authors = 36; // banyak nya karakter yang tercetak pada nama pengarang buku. ubah 0 jika nama tidak terpotong
$bookcard_fonts = "Arial, Verdana, Helvetica, 'Trebuchet MS'"; // font yang digunakan
$bookcard_number_row = 20; // jumlah baris kosong pada kartu buku
/*Add to Plugin Kartu Buku END*/
