...
$menu[] = array(__('Cetak Label & Barcodes'), MWB.'bibliography/label_barcode_generator.php', __('Print Label with Barcodes'));
$menu[] = array(__('Cetak Kartu Buku'), MWB.'bibliography/kartu_buku.php', _('Cetak Kartu Buku'));
