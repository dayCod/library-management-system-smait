...
<div class="flex h-screen w-full" id="visitor-counter" style="background: rgba(0,0,0,0.3)">
    <div class="bg-white w-full md:w-1/3 px-8 pt-8 pb-3 flex flex-col justify-between">
        <div>
            ...
            <form class="mt-4" @submit.prevent="onSubmit" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1"><?= __('Member ID')?></label>
                    <!-- FITUR VISITOR COUNTER: POIN 2.1 -->
                    <input v-model="memberId" ref="memberId" autofocus type="text" class="form-control" id="exampleInputEmail1" required="on"
                           aria-describedby="emailHelp" placeholder="<?= __('Enter your member ID')?>">
                    <!-- AKHIR POIN 2.1 -->
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1"><?= __('Institution')?></label>
                    <!-- FITUR VISITOR COUNTER: POIN 2.2 -->
                <input v-model="institution" type="text" class="form-control" id="exampleInputPassword1" required="on"
            ...
            onSubmit: function() {
                ...
                axios({
                    ...
                    .then(res => {
                        ...
                        // FITUR VISITOR COUNTER: POIN 3
                        if (this.memberId === '') {
                            window.setTimeout(function(){
                                window.location.href =  'index.php?p=visitor';
                            },8000);
                        }
                        ...
                        else if(this.memberId === '' && this.institution === '' ){
                            window.setTimeout(function(){
                                window.location.href =  'index.php?p=visitor';
                            },8000);
                        }
